...
export const GameControls = ({ isCurrentPlayer, gameStatus, onPlay, onPass }: GameControlsProps) => {
  if (!isCurrentPlayer || gameStatus !== "playing") return null;

  return (
    <div className="absolute bottom-16 md:bottom-64 left-1/2 -translate-x-1/2 flex gap-4 z-30">
      <Button
        variant="secondary"
        onClick={onPlay}
